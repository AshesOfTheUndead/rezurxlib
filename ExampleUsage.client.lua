...
--   • Glass + Glow visuals: layered depth shadows, spring entrance,
--     staggered tab openings (cursor glow & sheens removed in v4.0.1)
-- ============================================================
...
Overview:CreateButton({
        Name = "Primary Action",
        Variant = "Primary",                     -- accent-filled with ripple on click
...
VisualsTab:CreateCarousel({
        Items = {
                { Title = "Aurora", Content = "Layered depth shadows and a subtle accent rim." },
                { Title = "Depth",  Content = "The shadow deepens while you drag the window." },
                { Title = "Motion", Content = "Cards settle in sequence when a tab opens." },
        },
